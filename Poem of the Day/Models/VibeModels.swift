...
enum DailyVibe: String, Codable, CaseIterable {
    ...
    var poemPrompt: String {
        ...
        case .rebellious:
            return "Write a bold poem about defiance, resistance, and challenging the status quo. Capture the spirit of revolution, breaking boundaries, and standing up for beliefs."
        case .compassionate:
