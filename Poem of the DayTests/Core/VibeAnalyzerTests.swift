    ...
    func testColorIntensityWithExtremeSentiment() async throws {
        ...
        let veryPositiveArticles = [
            NewsArticle(
                ...
                content: "Joyful happy delighted thrilled successful beneficial helpful",
                publishedAt: Date(),
                source: NewsSource(name: "Test News", id: "test"),
                url: nil
            )
        ...
        let veryNegativeArticles = [
            NewsArticle(
                ...
                content: "Angry sad disappointed frustrated upset troubled",
                publishedAt: Date(),
                source: NewsSource(name: "Test News", id: "test"),
                url: nil
            )
        ...
        XCTAssertGreaterThan(positiveAnalysis.backgroundColorInfo.intensity, 0.5, 
                           "Very positive sentiment should increase color intensity")
        XCTAssertGreaterThan(negativeAnalysis.backgroundColorInfo.intensity, 0.5, 
